...
- To collaborate with policymakers, academic institutions and stakeholders to develop smart, socially just and healthy cities
- To serve as a resource for Bloustein masters programs

## 4th Floor Renovations
- RUCI Lab has been under construction since the Spring
- Computer lab with collaborative spaces for students

## How it Started

![](figures/initial_lab.jpg){width=80%}

## How it's Going

![](figures/lab_space.jpg){width=80%}
...
- We work with Bloustein students on a per-project basis depending on availability and resources.
...
Website: [rucilab.rutgers.edu](https://rucilab.rutgers.edu)
